...
const ASSIST_OPTIONS = [
  {
   ...
   image: "/images/assist_default.jpg", // 👈 THIS is the default image
 },
 {
   id: "marketing",
   label: "Marketing",
    ...
    <section className="container mx-auto px-6 pt-40 pb-24 grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="space-y-6">
        <GlassCard
          ...
          desc="Value-focused financial planning."
        />
        <GlassCard
          icon={<TrendingUp size={32} />}
          title="Marketing Solutions"
          desc="Branding & growth strategy."
        />
        <GlassCard
          icon={<Users size={28} />}
          title="HR Consulting"
          desc="People & leadership excellence."
        />
      </div>
    </section>
        {/* ---------------- What We Do ---------------- */}
          ...
          <div className="container mx-auto px-6 py-16 grid md:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-xl ">
                <br />
                <br />
                Learn more about our core areas of expertise by <br />selecting your topic of interest.
              </p>
...
export default function App() {
  ...
  {/* Mobile Menu */}
  {menuOpen && (
    <div className="md:hidden bg-white dark:bg-gray-900 w-full absolute top-full left-0 shadow-lg z-40">
      <ul className="flex flex-col gap-4 p-6 text-lg font-medium">
        ...
        <Link to="/faq" onClick={() => setMenuOpen(false)} className="hover:text-red-600">FAQ</Link>
        <Link to="/contactus" onClick={() => setMenuOpen(false)} className="hover:text-red-600">Contact</Link>
      </ul>
    </div>
  )}
</nav>
      ...
      {/* Footer */}
      {/* <footer className="bg-white/80 dark:bg-gray-900/80 border-t py-10 text-center text-sm">
        <div className="text-red-900 font-semibold text-lg mb-2">
          Aaravi Consulting
        </div>
        <p>Building smarter strategies. Creating sustainable growth.</p>
        <p className="mt-4">
          © {new Date().getFullYear()} Aaravi Consulting. All rights reserved.
        </p>
      </footer> */}
    </div>
  );
